...
namespace Climb.WebUtility
{
    ...
    public class Request
    {
        ...
        public static bool IsBrowserGet()
        {
            ...
            {
                if (str.IndexOf(strArray[i], StringComparison.Ordinal) >= 0)
                {
                    return true;
                }
            }
        ...
        public static string GetHomeBaseUrl(string FileName)
        {
            ...
            return string.Format("{0}/{1}", Script_Name.Remove(Script_Name.LastIndexOf("/", StringComparison.Ordinal)), FileName);
        }
        ...
        public static string GetScriptNameExt
        {
            get
            {
                return GetScriptName.Substring(GetScriptName.LastIndexOf(".", StringComparison.Ordinal) + 1);
            }
        }
